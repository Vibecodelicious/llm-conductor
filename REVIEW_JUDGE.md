...
### Special Rules: Code Hygiene

**Dead Code**
- Always APPROVED - dead code should be removed
- This includes unused functions, variables, imports, and unreachable code

**Other Hygiene Issues (style, formatting, minor cleanup)**
- APPROVED if there are other approved findings (developer is already revising)
- REJECTED if they would be the only approved items (not worth a revision cycle alone)
